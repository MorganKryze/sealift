 ...
 */
export function FailureBlock({ projectId, analysisId, message, detail, heading = "Analysis stopped", actions }: FailureBlockProps) {
  ...
  return (
    <div role="alert" className="animate-enter mt-4 rounded-xl border border-severity-critical/35 bg-severity-critical/5 p-5">
      <h3 className="text-base font-semibold text-severity-critical-fg">{heading}</h3>
