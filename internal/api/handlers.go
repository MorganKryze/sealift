...
func statusFor(err error) int {
	...
	case errors.Is(err, jobs.ErrSignatureKeyMissing), errors.Is(err, jobs.ErrNothingToExport), errors.Is(err, store.ErrInvalidTarget), errors.Is(err, tools.ErrInvalidTrivyVersion):
